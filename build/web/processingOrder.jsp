        ...
        <section> <!--load all order of the user at here--> 
            ...
            <%
                ...
                if (list != null && !list.isEmpty()) {
                    for (Order ord : list) {
                        if (request.getParameter("type").equals("pro")) {
                            if (ord.getStatus() == 1) {
                                count++;%> 
                ...
                <tr><td><%= ord.getOrderID()%></td>
                    ...
                    <td><%= status[ord.getStatus()]%>
                        ...
                        <form action="mainController" method="post" id="myform">
                            ...
                            <input type="button" value="Cancel order" onclick="myFunction()" >
                        </form>
                        <%if (request.getAttribute("messCan") != null) {%>
                        <p style="color:red;"><%= request.getAttribute("messCan")%></p>
                        <%}%>
                    </td>
            ...
            <%if (request.getAttribute("messCan") != null) {
                    if (request.getAttribute("messCan").equals("true")) {
            %>
