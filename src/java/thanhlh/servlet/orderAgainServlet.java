    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (orderid != null) {
                ...
                if (OrderDAO.checkOrdAgain(orderID)) {
                    request.setAttribute("messCheck", "true");

                } else {
                    request.setAttribute("messCheck", "false");
                    
                }
            }
            RequestDispatcher rd = request.getRequestDispatcher("FilterOrder");
